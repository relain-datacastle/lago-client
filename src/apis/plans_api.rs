...
pub async fn create_plan(configuration: &configuration::Configuration, plan_create_input: models::PlanCreateInput) -> Result<models::Plan, Error<CreatePlanError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&plan_create_input);
...
pub async fn destroy_plan(configuration: &configuration::Configuration, code: &str) -> Result<models::Plan, Error<DestroyPlanError>> {
    let local_var_configuration = configuration;
...
pub async fn find_all_plans(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::PlansPaginated, Error<FindAllPlansError>> {
    let local_var_configuration = configuration;
...
pub async fn find_plan(configuration: &configuration::Configuration, code: &str) -> Result<models::Plan, Error<FindPlanError>> {
    let local_var_configuration = configuration;
...
pub async fn update_plan(configuration: &configuration::Configuration, code: &str, plan_update_input: models::PlanUpdateInput) -> Result<models::Plan, Error<UpdatePlanError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&plan_update_input);
