...
pub struct PlanUpdateInputPlan {
    ...
    pub charges: Option<Vec<models::PlanUpdateInputPlanChargesInner>>,
    ...
    #[serde(rename = "cascade_updates", skip_serializing_if = "Option::is_none")]
    pub cascade_updates: Option<bool>,
}

impl PlanUpdateInputPlan {
    pub fn new() -> PlanUpdateInputPlan {
        PlanUpdateInputPlan {
            name: None,
