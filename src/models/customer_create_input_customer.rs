...
pub struct CustomerCreateInputCustomer {
    ...
    pub integration_customers: Option<Vec<models::CustomerCreateInputCustomerIntegrationCustomersInner>>,
    ...
    pub metadata: Option<Vec<models::CustomerCreateInputCustomerMetadataInner>>,
}

impl CustomerCreateInputCustomer {
    pub fn new(external_id: String) -> CustomerCreateInputCustomer {
