...
pub struct ChargePropertiesVolumeRangesInner {
...
impl ChargePropertiesVolumeRangesInner {
    pub fn new(from_value: i32, to_value: i32, flat_amount: String, per_unit_amount: String) -> ChargePropertiesVolumeRangesInner {
