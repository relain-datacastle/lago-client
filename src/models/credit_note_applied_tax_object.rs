...
pub struct CreditNoteAppliedTaxObject {
    /// Unique identifier of the credit note, created by Lago.
    #[serde(rename = "lago_credit_note_id", skip_serializing_if = "Option::is_none")]
    pub lago_credit_note_id: Option<uuid::Uuid>,
...
impl CreditNoteAppliedTaxObject {
    pub fn new() -> CreditNoteAppliedTaxObject {
        CreditNoteAppliedTaxObject {
            lago_credit_note_id: None,
