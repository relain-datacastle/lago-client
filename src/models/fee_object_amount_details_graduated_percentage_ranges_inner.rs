...
pub struct FeeObjectAmountDetailsGraduatedPercentageRangesInner {
...
impl FeeObjectAmountDetailsGraduatedPercentageRangesInner {
    pub fn new(units: String, from_value: i32, to_value: i32, flat_unit_amount: String, rate: String, per_unit_total_amount: String, total_with_flat_amount: String) -> FeeObjectAmountDetailsGraduatedPercentageRangesInner {
