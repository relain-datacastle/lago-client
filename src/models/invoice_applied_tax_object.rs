...
pub struct InvoiceAppliedTaxObject {
    ...
    #[serde(rename = "fees_amount_cents", skip_serializing_if = "Option::is_none")]
    pub fees_amount_cents: Option<i32>,
...
impl InvoiceAppliedTaxObject {
    pub fn new() -> InvoiceAppliedTaxObject {
        InvoiceAppliedTaxObject {
            lago_invoice_id: None,
            fees_amount_cents: None,
            lago_id: None,
            lago_tax_id: None,
            tax_name: None,
            tax_code: None,
