...
impl SubscriptionObject {
    pub fn new(lago_id: uuid::Uuid, external_id: String, lago_customer_id: uuid::Uuid, external_customer_id: String, billing_time: BillingTime, plan_code: String, status: Status, created_at: String, subscription_at: String) -> SubscriptionObject {
        SubscriptionObject {
            lago_id,
            external_id,
            lago_customer_id,
