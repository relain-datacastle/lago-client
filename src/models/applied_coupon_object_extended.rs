...
pub struct AppliedCouponObjectExtended {
    ...
    pub credits: Vec<models::CreditObject>,
}

impl AppliedCouponObjectExtended {
    pub fn new(lago_id: uuid::Uuid, lago_coupon_id: uuid::Uuid, coupon_code: String, coupon_name: String, lago_customer_id: uuid::Uuid, external_customer_id: String, status: Status, frequency: Frequency, created_at: String, credits: Vec<models::CreditObject>) -> AppliedCouponObjectExtended {
