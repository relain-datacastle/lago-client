...
/// WalletCreateInputWalletRecurringTransactionRulesInner : Object that represents rule for wallet recurring transactions.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WalletCreateInputWalletRecurringTransactionRulesInner {
...
impl WalletCreateInputWalletRecurringTransactionRulesInner {
    /// Object that represents rule for wallet recurring transactions.
    pub fn new(trigger: Trigger) -> WalletCreateInputWalletRecurringTransactionRulesInner {
