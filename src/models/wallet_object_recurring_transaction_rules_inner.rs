...
/// WalletObjectRecurringTransactionRulesInner : Object that represents rule for wallet recurring transactions.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct WalletObjectRecurringTransactionRulesInner {
    ...
    #[serde(rename = "target_ongoing_balance")]
    pub target_ongoing_balance: String,
...
impl WalletObjectRecurringTransactionRulesInner {
    /// Object that represents rule for wallet recurring transactions.
    pub fn new(lago_id: uuid::Uuid, trigger: Trigger, method: Method, interval: Interval, threshold_credits: String, paid_credits: String, granted_credits: String, target_ongoing_balance: String, created_at: String) -> WalletObjectRecurringTransactionRulesInner {
